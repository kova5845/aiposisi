...
--
CREATE TABLE "catalog_computergame" (
...
CREATE TABLE "catalog_platform_game" (
	"id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, 
	"platform_id" integer NOT NULL REFERENCES "catalog_platform" ("id") DEFERRABLE INITIALLY DEFERRED, 
	"computergame_id" integer NOT NULL REFERENCES "catalog_computergame" ("id") DEFERRABLE INITIALLY DEFERRED);
--
-- Create model Engine
--
CREATE TABLE "catalog_engine" (
	...
	"date" datetime NOT NULL, 
	"game_id" integer NOT NULL REFERENCES "catalog_computergame" ("id") DEFERRABLE INITIALLY DEFERRED);
--
